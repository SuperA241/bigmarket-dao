...
(define-public (resolve-market (market-id uint))
  (let (
      ...
      (price-data (unwrap! (contract-call? 'ST20M5GABDT6WYJHXBT5CDH4501V1Q65242SPRMXH.pyth-oracle-v3 read-price-feed price-feed-id 'ST20M5GABDT6WYJHXBT5CDH4501V1Q65242SPRMXH.pyth-storage-v3) err-category-not-found))

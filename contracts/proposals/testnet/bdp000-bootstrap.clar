...
(define-public (execute (sender principal))
	(begin
		...
		(try! (contract-call? .bme003-0-core-proposals set-core-team-member 'ST2CS5XAA3FNHEQZRDVF6YY0NTAK7JFV7PKF1CPVM true))
		(try! (contract-call? .bme003-0-core-proposals set-core-team-member 'ST1W59M686N2VZE37TGJYJCYMR018NSZJV05WZ4CY true))

		;; Set executive team members.
		(try! (contract-call? .bme004-0-core-execute set-executive-team-member 'ST2CS5XAA3FNHEQZRDVF6YY0NTAK7JFV7PKF1CPVM true))
		(try! (contract-call? .bme004-0-core-execute set-executive-team-member 'ST1W59M686N2VZE37TGJYJCYMR018NSZJV05WZ4CY true))
		(try! (contract-call? .bme004-0-core-execute set-executive-team-member 'STPBQA353JF9PC2T9NHEF0P155MNM7SMJ8KDGB09 true))
		(try! (contract-call? .bme004-0-core-execute set-executive-team-member 'ST2Z6MAFHXQ2ARTSZYNGE1HGJPKE1JDS6EMCTXX94 true))
		...
		(try! (contract-call? .bme022-0-market-gating set-merkle-root-by-principal .bme023-0-market-predicting 0xe6b0a3652319a9d8735f2fde4f36e578abc6eeb3c5eab85dbc994afc034ae8ee))
		(try! (contract-call? .bme023-0-market-predicting set-resolution-agent 'ST167Z6WFHMV0FZKFCRNWZ33WTB0DFBCW9M1FW3AY))
		(try! (contract-call? .bme023-0-market-predicting set-dev-fund 'ST2Z6MAFHXQ2ARTSZYNGE1HGJPKE1JDS6EMCTXX94))
		...
		(try! (contract-call? .bme023-0-market-predicting set-market-create-fee u1000000))
		(try! (contract-call? .bme023-0-market-predicting set-market-fee-bips-max u1000))
		(try! (contract-call? .bme023-0-market-predicting set-dev-fee-bips u200))
		(try! (contract-call? .bme023-0-market-predicting set-dao-fee-bips u200))
		(try! (contract-call? .bme023-0-market-predicting set-dispute-window-length u6))
		(try! (contract-call? .bme023-0-market-predicting set-allowed-token 'ST11804SFNTNRKZQBWB1R3F5YHEXSTXXEWZDXTMH6.wrapped-stx true))
		(try! (contract-call? .bme023-0-market-predicting set-allowed-token 'ST11804SFNTNRKZQBWB1R3F5YHEXSTXXEWZDXTMH6.sbtc true))
		(try! (contract-call? .bme023-0-market-predicting set-allowed-token 'ST11804SFNTNRKZQBWB1R3F5YHEXSTXXEWZDXTMH6.bme000-0-governance-token true))

		(try! (contract-call? .bme021-0-market-voting set-voting-duration u12))

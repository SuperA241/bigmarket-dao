...
(define-public (execute (sender principal))
	(begin
		...
		(try! (contract-call? .bme023-0-market-predicting set-resolution-agent 'ST3RR3HF25CQ9A5DEWS4R1WKJSBCFKQXFBYPJK3WV))
		(try! (contract-call? .bme023-0-market-predicting set-dev-fund 'ST3JP0N1ZXGASRJ0F7QAHWFPGTVK9T2XNZN9J752))

...
(define-public (execute (sender principal))
	(begin
		...
		(try! (contract-call? .bme003-core-proposals set-core-team-member 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM true))
		(try! (contract-call? .bme003-core-proposals set-core-team-member 'ST1SJ3DTE5DN7X54YDH5D64R3BCB6A2AG2ZQ8YPD5 true))

		;; Set executive team members.
		(try! (contract-call? .bme004-core-execute set-executive-team-member 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM true))
		(try! (contract-call? .bme004-core-execute set-executive-team-member 'ST1SJ3DTE5DN7X54YDH5D64R3BCB6A2AG2ZQ8YPD5 true))
		(try! (contract-call? .bme004-core-execute set-executive-team-member 'ST2CY5V39NHDPWSXMW9QDT3HC3GD6Q6XX4CFRK9AG true))
		(try! (contract-call? .bme004-core-execute set-executive-team-member 'ST2JHG361ZXG51QTKY2NQCVBPPRRE2KZB1HR05NNC true))
		...
		(try! (contract-call? .bme022-market-gating set-merkle-root-by-principal .bme023-market-predicting 0x26067618f71da1da6fa33c9b7f8d989b87f71ade892e1c55ce3b46ac79a7e64e))
		(try! (contract-call? .bme023-market-predicting set-resolution-agent 'ST2CY5V39NHDPWSXMW9QDT3HC3GD6Q6XX4CFRK9AG))
		(try! (contract-call? .bme023-market-predicting set-dev-fund 'ST2JHG361ZXG51QTKY2NQCVBPPRRE2KZB1HR05NNC))
		...
		(try! (contract-call? .bme023-market-predicting set-allowed-token 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.wrapped-stx true))
		(try! (contract-call? .bme023-market-predicting set-allowed-token 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.sbtc true))
		
		(try! (contract-call? .bme023-market-predicting set-market-fee-bips-max u300))
		(try! (contract-call? .bme023-market-predicting set-market-create-fee u100000000))
		(try! (contract-call? .bme023-market-predicting set-dev-fee-bips u100))
		(try! (contract-call? .bme023-market-predicting set-dao-fee-bips u150))
		(try! (contract-call? .bme023-market-predicting set-dispute-window-length u24))

		(try! (contract-call? .bme021-market-voting set-voting-duration u24))
		(try! (contract-call? .bme010-token-sale initialize-ido))

		;;(try! (contract-call? .bme023-market-predicting set-allowed-token .bme000-governance-token true))
		...
		(try! (contract-call? .bme000-governance-token bmg-mint-many
			(list
				...
				;;{amount: u1000000000, recipient: .bme006-treasury}

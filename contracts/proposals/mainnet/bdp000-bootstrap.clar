	...
	(begin
		...
		(try! (contract-call? .bigmarket-dao set-extensions
			(list
				...
				;;{extension: .bme004-0-core-execute, enabled: false}
				{extension: .bme006-0-treasury, enabled: true}
				;;{extension: .bme010-0-token-sale, enabled: false}
		...
		(try! (contract-call? .bme000-0-governance-token bmg-mint-many
			(list
				...
				{amount: u1000000000, recipient: 'ST2X0FMCBMBK3F41WVS8PKN75PF9H5ZDRJB7H600B}

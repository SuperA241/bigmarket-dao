...
describe('prediction fees and stakes', () => {
	...
	it('alice hedges yes and no', async () => {
		...
		expect(aliceStake).toEqual(
			Cl.some(Cl.list([Cl.uint(0), Cl.uint(1980000n), Cl.uint(0), Cl.uint(0), Cl.uint(0), Cl.uint(0), Cl.uint(0), Cl.uint(0), Cl.uint(0), Cl.uint(0)]))
		);
		...
		expect(aliceStake).toEqual(
			Cl.some(Cl.list([Cl.uint(3960000n), Cl.uint(1980000n), Cl.uint(0), Cl.uint(0), Cl.uint(0), Cl.uint(0), Cl.uint(0), Cl.uint(0), Cl.uint(0), Cl.uint(0)]))
		);
	});
});
